...
# FIXME: Implement real tests, potentially with moking of microSAM segmentation
...
#     ],
# )
# def test_microsam_segmentation_task(
...
#     ],
# )
# def test_microsam_segmentation_task_masked(
#     tmp_path: Path, shape: tuple[int, ...], axes: str
# ):
